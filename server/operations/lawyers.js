...
const self = {
  ...
  initialize: async () => {
    ...
    await self.page.$eval("#what_search", (el) => (el.value = "Anwälte"));
  ...
  getResults: async () => {
    ...
    while (true) {
      ...
      try {
        ...
        console.log("Konnte den Button nicht finden, das Ende ist nah.");
      ...
      console.log("Klicke den next button.");
